...
const CommerceAPI = (config: any) => {
  ...
  return {
    ...
    // eslint-disable-next-line max-len
    estimatePurchase: (customerIdentifier: any, { fromCurrency, amount }: any) =>
      instance.put(`customers/${customerIdentifier}/purchase/estimate`, {
        params: { "from-currency": fromCurrency, amount },
      }),
    // eslint-disable-next-line max-len
    estimateWithdraw: (customerIdentifier: any, { fromCurrency, amount }: any) =>
    ...
    // eslint-disable-next-line max-len
    p2p: (customerIdentifier: any, { fromCurrency, amount, toCustomerNumber }: any) =>
