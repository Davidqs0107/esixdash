...
const OperatingAPI = (config: any) => {
  ...
  return {
    ...
    addExchange: (programName: any, exchangeName: any) =>
      instance.post(`${encodeURIComponent(programName)}/exchanges/${exchangeName}`),
    ...
    get: (programName: any) => instance.get(`${encodeURIComponent(programName)}`),
    ...
    getExchanges: (programName: any) => instance.get(`${encodeURIComponent(programName)}/exchanges`),
    ...
    getInvoiceSummaries: (programName: any, invoiceId: any) =>
      instance.get(`${encodeURIComponent(programName)}/invoices/${invoiceId}/summaries`),
    // eslint-disable-next-line max-len
    getInvoiceSummary: (programName: any, invoiceId: any, invoiceSummaryId: any) =>
      instance.get(
        `${encodeURIComponent(programName)}/invoices/${invoiceId}/summaries/${invoiceSummaryId}`
      ),
    ...
    getInvoices: (
      ...
      instance.get(`${encodeURIComponent(programName)}/custodial/${currency}/invoices`, {
        params: { state, count, "start-index": startIndex, ascending },
      }),
    getProgramReport: (programName: any) => instance.get(`${encodeURIComponent(programName)}/report`),
    list: () => instance.get(""),
    // eslint-disable-next-line max-len
    ...
    removeExchange: (programName: any, exchangeName: any) =>
      instance.delete(`${encodeURIComponent(programName)}/exchanges/${exchangeName}`),
    // eslint-disable-next-line max-len
    updateInvoiceSummary: (programName: any, invoiceId: any, invoiceSummaryId: any, dto: any) =>
      instance.post(
        `${encodeURIComponent(programName)}/invoices/${invoiceId}/summaries/${invoiceSummaryId}`,
        dto
      ),
