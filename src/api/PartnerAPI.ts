...
const PartnerAPI = (config: any) => {
  ...
  return {
    ...
    deleteExchangeMargin2: (exchangeName: any, currency: any, programName: any, feePlanName: any) =>
      instance.delete(
        `exchanges/${exchangeName}/margins/${currency}/${encodeURIComponent(programName)}/${feePlanName}`
      ),
    ...
    // eslint-disable-next-line max-len
    getBlockedReferences: (partnerName: any, { count, startIndex, ascending }: any) =>
    ...
    // eslint-disable-next-line max-len
    getExchangeMargin2: (exchangeName: any, currency: any, programName: any, feePlanName: any) =>
      instance.get(
        `exchanges/${exchangeName}/margins/${currency}/${encodeURIComponent(programName)}/${feePlanName}`
      ),
    ...
    getPartnerProfile: (partnerName: any) => instance.get(`${partnerName}/profile`),
