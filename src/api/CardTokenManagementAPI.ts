...
const CardTokenManagementAPI = (config: any) => {
  ...
  return {
    ...
    activateToken: (cardId: any, dto: any) =>
      instance.put(`/activate/${cardId}`, dto),
    deleteToken: (cardId: any, dto: any) =>
      instance.put(`/delete/${cardId}`, dto),
    ...
    suspendToken: (cardId: any, dto: any) =>
      instance.put(`/suspend/${cardId}`, dto),
    unsuspendToken: (cardId: any, dto: any) =>
      instance.put(`/unsuspend/${cardId}`, dto),
  };
};
