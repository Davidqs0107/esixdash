...
const MailTemplateAPI = (config: any) => {
  ...
  return {
    ...
    createMailTemplate: (programName: any, language: any, dto: any) =>
      instance.post(`${encodeURIComponent(programName)}/mail/${language}/templates`, dto),
    createMailTemplateSet: (programName: any, dto: any) =>
      instance.post(`${encodeURIComponent(programName)}/mail`, dto),
    deleteMailTemplate: (programName: any, language: any, mailTemplateId: any) =>
      instance.delete(
        `${encodeURIComponent(programName)}/mail/${language}/templates/${mailTemplateId}`
      ),
    ...
    getMailTemplateSets: (programName: any) => instance.get(`${encodeURIComponent(programName)}/mail`),
    getMailTemplates: (programName: any, language: any) =>
      instance.get(`${encodeURIComponent(programName)}/mail/${language}/templates`),
  };
};
