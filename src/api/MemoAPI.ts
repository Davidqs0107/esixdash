...
const MemoAPI = (config: any) => {
  ...
  return {
    ...
    createMemoTemplate: (programName: any, language: any, dto: any) =>
      instance.post(`${encodeURIComponent(programName)}/memos/${language}/templates`, dto),
    createMemoTemplateSet: (programName: any, dto: any) =>
      instance.post(`${encodeURIComponent(programName)}/memos`, dto),
    deleteMemoTemplate: (programName: any, language: any, memoTemplateId: any) =>
      instance.delete(
        `${encodeURIComponent(programName)}/memos/${language}/templates/${memoTemplateId}`
      ),
    ...
    getMemoTemplateSets: (programName: any) => instance.get(`${encodeURIComponent(programName)}/memos`),
    getMemoTemplates: (programName: any, language: any) =>
      instance.get(`${encodeURIComponent(programName)}/memos/${language}/templates`),
  };
};
