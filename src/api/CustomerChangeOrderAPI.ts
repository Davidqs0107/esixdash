...
const CustomerChangeOrderAPI = (config: any) => {
  ...
  return {
    ...
    approveChangeOrder: (customerIdentifier: any, changeOrderId: any, dto: any) =>
      instance.post(
        `${customerIdentifier}/change-orders/${changeOrderId}`,
        dto
      ),
    // eslint-disable-next-line max-len
    createAdjustmentRequest: (customerIdentifier: any, changeOrderId: any, dto: any) =>
      instance.post(
    ...
    // eslint-disable-next-line max-len
    createUpdateChargeoffRequest: (customerIdentifier: any, changeOrderId: any, dto: any) =>
      instance.put(
    ...
    // eslint-disable-next-line max-len
    discardChangeOrder: (customerIdentifier: any, changeOrderId: any, memo: any) =>
    ...
    getChangeOrders: (
      ...
      httpProxy.get(`${customerIdentifier}/change-orders`, {
    ...
    // eslint-disable-next-line max-len
    getChangeRequest: (customerIdentifier: any, changeOrderId: any, changeRequestId: any) =>
      instance.get(
