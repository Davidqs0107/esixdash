...
const PageNavProduct: React.FC<IPageNavProduct> = ({
  ...
  const [editModeInterestAccrual, setEditModeInterestAccrual] =
    useState<boolean>();
  const [savingInterestAccrual, setSavingInterestAccrual] = useState<boolean>();
  const [savingCredit, setSavingCredit] = useState<boolean>();
  ...
  const getAutoLoadRules = async (customerNumber: string) => {
    try {
      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
      // @ts-ignore
      const results = await api.AutoloadAPI.getAutoLoadRules(customerNumber);
      if (results.length > 0) {
        const { id, externalReferenceId, enabled, config } = results.shift();
        setAutoloadRule({
  ...
  const setCustomerProduct = (product: OfferingCustomerSummary) => {
    ...
    getAutoLoadRules(customerSummary.customerNumber);
  };
  ...
  const getOfferingProgram = (program: string) => {
    ...
    api.ProductAPI.getProgramProduct(program)
      .then((program: Program) => {
        ...
        setProgramConfig(program.config);
        if (program.config.interestTiers) {
          const tierNames: typeof interestTierNames = [];
          Object.keys(program.config.interestTiers).forEach((tier) =>
            tierNames.push({
              label: tier,
              value: tier,
            })
  ...
  const cutoffDate = (date: string | number) => {
    if (!date) return "";

    return moment(new Date(date)).format("h:mm:ss") == "12:00:00"
      ? moment(date).subtract(1, "day").valueOf()
      : date;
  };
  ...
  const creditFromSchema = Yup.object().shape({
  ...
  return product ? (
    <Formik
      ...
      validationSchema={creditFromSchema}
      onSubmit={() => {}}
      enableReinitialize
    >
        ...
        <Form>
          <Box>
                  ...
                  <Box className="cardBody">
                    <Grid container spacing={3}>
                      <Grid item lg={6}>
                        ...
                        <Label variant="grey" regular>
                          <FormattedMessage
                            id="lastCycleBalance"
                            defaultMessage="Last Cycle Balance"
                          />
                        </Label>
                      </Grid>
                      <Grid item lg={6}>
                    ...
                    <Grid container spacing={3}>
                      <Grid item lg={6}>
                        ...
                        <Label variant="grey" regular>
                          <FormattedMessage
                            id="lastCycleCloseDate"
                            defaultMessage="Last Cycle Close Date"
                          />
                        </Label>
                      </Grid>
                      <Grid item lg={6}>
                        <Label variant="labelDark" bold>
                          {lastBillingHistory
                            ? convertDate(
                                cutoffDate(
                                  lastBillingHistory.repaymentPeriodEnd
                                )
                              )
                            : "--"}
                        </Label>
                  ...
                  <Box className="cardBody">
                    <Grid container spacing={3}>
                      <Grid item lg={6}>
                        <Label variant="labelDark" bold>
                          {convertDate(
                            cutoffDate(product.currentRepaymentEndDate)
                          )}
                        </Label>
                        <Label variant="grey" regular>
                          <FormattedMessage
                            id="nextRepaymentEndDate"
                            defaultMessage="Next Repayment End Date"
                          />
                        </Label>
                      </Grid>
                      <Grid item lg={6}>
                        ...
                        <Label variant="grey" regular>
                          <FormattedMessage
                            id="repaymentPeriodLength"
                            defaultMessage="Repayment Period Length"
                          />
                        </Label>
                      </Grid>
                    </Grid>
                    <Grid container spacing={3}>
                      <Grid item lg={6}>
                        <Label variant="labelDark" bold>
                          {convertDate(
                            cutoffDate(product.currentBillingEndDate)
                          )}
                        </Label>
                        <Label variant="grey" regular>
                          <FormattedMessage
                            id="nextBillingPeriodEndDate"
                            defaultMessage="Next Billing Period End Date"
                          />
                        </Label>
                      </Grid>
                      <Grid item lg={6}>
                        ...
                        <Label variant="grey" regular>
                          <FormattedMessage
                            id="billingPeriodLength"
                            defaultMessage="Billing Period Length"
                          />
                        </Label>
                      </Grid>
                    </Grid>
            ...
            <Grid container spacing={3}>
              <Grid item lg={4}>
                <StyledCard
                  className={savingInterestAccrual ? "submitting" : ""}
                >
                  <Grid container className="cardHeader">
                    <Grid item flexGrow="1">
                      <Header
                          ...
                          <QDButton
                            ...
                            onClick={() => {
                              ...
                              api.ProductAPI.updateOfferingCustomer(
                                ...
                                .then((product: OfferingCustomerSummary) => {
                                  setSavingInterestAccrual(false);
                          ...
                          Object.keys(programConfig?.interestTiers).length !==
                            ...
                            <>
                              ...
                              <Label variant="grey" regular>
                                <FormattedMessage
                                  id="interestRateTier"
                                  defaultMessage="Interest Rate Tier"
                                />
                              </Label>
                            </>
                          )
              ...
              <Grid item lg={4}>
                <StyledCard className={savingCredit ? "submitting" : ""}>
                  <Grid container className="cardHeader">
                    <Grid item flexGrow="1">
                      <Header
                        value={intl.formatMessage(
                      ...
                      {editModeCredit ? (
                        ...
                        >
                          ...
                          <DrawerComp
                            ...
                            label={intl.formatMessage({
                              id: "viewPreviousMinPaymentHistory",
                    ...
                    <Grid container spacing={3}>
                      <Grid item lg={6}>
                        ...
                        <Label variant="grey" regular>
                          <FormattedMessage
                            id="unpaidMinimums"
                            defaultMessage="Unpaid Minimums"
                          />
                        </Label>
                      </Grid>
                      <Grid item lg={6}></Grid>
                      ...
                      <Grid container spacing={3}>
                        <Grid item lg={6}>
                          <Label variant="labelDark" bold>
                            {product?.autoLoadEndDate
                              ? convertDate(cutoffDate(product.autoLoadEndDate))
                              : "N/A"}
                          </Label>
                          <Label variant="grey" regular>
                            Next Payment Date
                        ...
                        <Grid item lg={6}>
                          <Label variant="labelDark" bold>
                            {autoloadRule
                              ? toTitleCase(
                                  autoloadRule.autoLoadStrategy.replace(
                                    "_",
                                    " "
                                  )
                                )
                        ...
                        <Grid item container spacing={3}>
                          <Grid item lg={6}>
                            <Label variant="labelDark" bold>
                              {autoloadRule
                                ? toTitleCase(autoloadRule.frequency)
                                : "--"}
                            </Label>
                            <Label variant="grey" regular>
                              Frequency
                          ...
                          {autoloadRule?.fixedAmount ? (
                            <Grid item lg={6}>
                              <QDFormattedCurrency
                                className="label-dark-bold"
                                currency={homeCurrency}
                                amount={autoloadRule.fixedAmount}
                              />
                              <Label variant="grey" regular>
                                Custom Amount
                              </Label>
                    ...
                    <Box className="cardBody">
                      <Grid container spacing={3}>
                        <Grid item lg={4}>
                          ...
                          <Label variant="grey" regular>
                            <FormattedMessage
                              id="currentPrincipal"
                              defaultMessage="Current Principal"
                            />
                          </Label>
                        </Grid>
                        <Grid item lg={4}>
                          ...
                          <Label variant="grey" regular>
                            <FormattedMessage
                              id="currentInterest"
                              defaultMessage="Current Interest"
                            />
                          </Label>
                        </Grid>
                        <Grid item lg={4}>
                          ...
                          <Label variant="grey" regular>
                            <FormattedMessage
                              id="currentBilledInterest"
                              defaultMessage="Current Billed Interest"
                            />
                          </Label>
                        </Grid>
                      </Grid>
                      <Grid container spacing={3}>
                        <Grid item lg={4}>
                          ...
                          <Label variant="grey" regular>
                            <FormattedMessage
                              id="previousPrincipal"
                              defaultMessage="Previous Principal"
                            />
                          </Label>
                        </Grid>
                        <Grid item lg={4}>
                          ...
                          <Label variant="grey" regular>
                            <FormattedMessage
                              id="previousInterest"
                              defaultMessage="Previous Interest"
                            />
                          </Label>
                        </Grid>
                        <Grid item lg={4}>
                          ...
                          <Label variant="grey" regular>
                            <FormattedMessage
                              id="previousBilledInterest"
                              defaultMessage="Previous Billed Interest"
                            />
                          </Label>
                        </Grid>
                      </Grid>
                      <Grid container spacing={3}>
                        ...
                        <Grid item lg={4}>
                          ...
                          <Label variant="grey" regular>
                            <FormattedMessage
                              id="owedBilledInterest"
                              defaultMessage="Owed Billed Interest"
                            />
                          </Label>
                        </Grid>
                      </Grid>
