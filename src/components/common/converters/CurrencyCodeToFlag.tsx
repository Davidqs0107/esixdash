...
const CurrencyCodeToFlag: React.FC<ICurrencyCodeToFlag> = ({
  currencyCode,
  width = 30,
  height = 30,
  className,
    ...
    <Avatar
      ...
      src={
        currencyCode.length > 3
          ? flagLookup.get("POINT")
          : flagLookup.get(currencyCode)
      }
...
export default CurrencyCodeToFlag;
