...
const PartnerSandboxAPI = (config) => {
    const { baseURL, ...others } = config;
    const instance = axios.create({ baseURL: `${baseURL}/v1/sandbox/`, ...others });

    return {
        interceptors: instance.interceptors,
        load: (cn, dto) => instance.post(`customer/${cn}/load`, dto),
    };
};

export default PartnerSandboxAPI;
